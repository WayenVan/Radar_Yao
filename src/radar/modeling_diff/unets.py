...
@dataclass
class U_NetOutput(BaseOutput):
    sample: torch.FloatTensor


class U_Net(ModelMixin, ConfigMixin):
    """
    ...
    @register_to_config
    def __init__(self, in_ch=3, out_ch=1, sample_size: Union[int, tuple] = 256):
